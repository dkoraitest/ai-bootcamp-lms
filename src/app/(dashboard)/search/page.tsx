...
const LESSONS: SearchLesson[] = [
  ...
  { id: 7,  type: "lesson", title: "4 уровня памяти агента",                            week: 4, date: "02.06.2026", topic: "Memory Architecture",                 status: "locked" },
  { id: 8,  type: "lesson", title: "Доверие, git, безопасность — инструментальный финал", week: 4, date: "04.06.2026", topic: "Trust, Git & Security",             status: "locked" },
...
const MATERIALS: SearchMaterial[] = [
  ...
  { id: 107, type: "material", title: "4 уровня памяти агента",                              materialType: "video",     week: 4, lessonTopic: "Память",            description: "Запись урока 7 · 02.06.2026" },
  { id: 108, type: "material", title: "Доверие, git, безопасность",                          materialType: "video",     week: 4, lessonTopic: "Trust + Git",      description: "Запись урока 8 · 04.06.2026" },
  ...
  { id: 117, type: "material", title: "Шаблон ресёрч-агента",                                materialType: "template",  week: 4, lessonTopic: "Research Agent",   description: "Готовый шаблон для форка под свою доменную задачу" },
  ...
  { id: 125, type: "material", title: "4 уровня памяти агента (L1-L4)",                       materialType: "technique", week: 4, lessonTopic: "Память",            description: "L1 встроенная · L2 файлы/БД · L3 RAG · L4 Graph", markdownContent: "## 4 уровня памяти\n\n1. **L1 · Встроенная** — Memory tool, CLAUDE.md, /memory. Setup = 0\n2. **L2 · Файлы и БД** — локальные файлы, CSV, SQLite, Supabase MCP\n3. **L3 · RAG** — семантический поиск через embeddings (ChromaDB)\n4. **L4 · Graph RAG** — граф знаний для реляционных вопросов\n\n**Правило:** не прыгай выше пока не упёрся ниже." },
  { id: 126, type: "material", title: "3 уровня доверия (Pope frame)",                        materialType: "technique", week: 4, lessonTopic: "Доверие",          description: "Read-only / Soft writes / Hard writes", markdownContent: "## 3 уровня доверия\n\n1. **L1 · Read-only** — поиск, чтение, отчёты. Риск нулевой. HW4 = этот уровень.\n2. **L2 · Soft writes** — drafts, человек подтверждает перед публикацией. Риск средний (обратимо).\n3. **L3 · Hard writes** — прямые изменения без подтверждения. Только с защитой (hooks, staging).\n\n**Правило:** начинай с L1, поднимай только когда агент доказал." },
...
const ASSIGNMENTS: SearchAssignment[] = [
  ...
  { id: 204, type: "assignment", hwNumber: 4, title: "Ресёрч-агент",            week: 4, deadline: "07.06.2026", status: "locked",      description: "Форкни шаблон ресёрч-агента и адаптируй под свою роль. Уровень доверия — read-only. Видео-демо 1 минута." },
