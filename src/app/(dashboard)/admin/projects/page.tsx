          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="bg-red-50 border border-red-200 rounded-lg p-8 flex flex-col items-center text-center">
              ...
              <p className="text-red-700 mb-6">
                У вас нет прав доступа к этой странице. Администраторы могут просматривать результаты.
              </p>
              <Link
                href="/"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-start gap-4 mb-2">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Результаты оценок проектов</h1>
                <p className="text-gray-600 mt-2">
                  Рейтинг студентов по средней оценке, которую им поставили
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8 flex items-start gap-3">
            ...
            <div className="text-sm text-blue-900">
              <p className="font-semibold mb-1">Только для администратора</p>
              <p>Эта страница показывает рейтинг студентов на основе оценок всех участников буткемпа.</p>
            </div>
          </div>
