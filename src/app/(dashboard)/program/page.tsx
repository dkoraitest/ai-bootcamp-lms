...
const ASSIGNMENTS: Record<number, AssignmentData> = {
  ...
  5: {
    ...
    description: "Собрать и опубликовать результат, применив три принципа вайб-кодинга, и завернуть повторяющееся действие в свою slash-команду. Плюс задание с разбора у Паши во вторник: своё приложение для работы с текстом через API модели.",
    ...
    checklist: [
      ...
      "Приложение для работы с текстом на Claude API или OpenAI собрано и работает",
    ],
    rubric: [
