...
export const PROGRAM_ASSIGNMENTS: AssignmentData[] = [
  ...
  },
  {
    ...
    submittedAt: null,
    description:
      "Собрать и опубликовать результат, применив три принципа вайб-кодинга, и завернуть повторяющееся действие в свою slash-команду. Плюс задание с разбора у Паши во вторник: своё приложение для работы с текстом через API модели.",
    requirements: [
    ...
    checklist: [
      ...
      { id: 5, text: "Приложение для работы с текстом на Claude API или OpenAI собрано и работает", done: false },
    ],
    feedback: null,
  },
  {
